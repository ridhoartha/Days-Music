...
× Jika Assistant Bot tidak bergabung Silahkan Tambahkan Secara Manual @{ASSISTANT_NAME} ke grup Anda dan coba lagi
...
× /video <judul lagu> : Untuk Mendownload Video di YouTube
× /song <judul lagu> : Untuk Mendownload Video di YouTube 
× /search <judul lagu> : Untuk Mencari Video di YouTube 
...
× /reload - Untuk MemRefresh admin list
"""
      ]
